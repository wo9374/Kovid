...
data class ClinicJson(
    ...
    @SerializedName(value = "weekOperTime", alternate = ["weekTime"]) val weekOperTime: String,           //주중 운영시간         //09:00~17:00
    @SerializedName(value = "satdayOperTime", alternate = ["satdayTime"]) val satdayOperTime: String,       //토요일 운영시간       //09:00~17:00
    @SerializedName(value = "weekendOperTime", alternate = ["weekendTime"]) val weekendOperTime: String,     //주말,공휴일 운영시간   //09:00~17:00
