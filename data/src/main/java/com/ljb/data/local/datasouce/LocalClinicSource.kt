...
interface LocalClinicSource {
    ...
    fun mapInfoJsonParsing(jsonSido: String, jsonSiGungu: String): List<SiDoModel>
}
...
class LocalClinicSourceImpl @Inject constructor(private val clinicDao: ClinicDao) :
    ...
    override fun mapInfoJsonParsing(jsonSido: String, jsonSiGungu: String): List<SiDoModel> {
        ...
        return siDoObject.getAsJsonArray("features").mapIndexed { idx, element ->
